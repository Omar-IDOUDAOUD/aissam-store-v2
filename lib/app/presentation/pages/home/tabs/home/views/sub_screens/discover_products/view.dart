...
class DiscoverProductsSubScreen extends ConsumerWidget {
  const DiscoverProductsSubScreen( 
      {super.key, required this.state, required this.loadData, required this.title,required this.description});
        ...
        child: CustomScrollView(
          slivers: [
            ...
            SliverPadding(
              ...
              sliver: ProductsGride(state: state),
            ),
          ],
        ),
      ),
