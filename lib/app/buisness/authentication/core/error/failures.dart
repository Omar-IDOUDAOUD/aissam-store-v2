...
class AuthenticationFailure extends Failure {
  ...
  factory AuthenticationFailure.fromAuthException(AuthException exception) => AuthenticationFailure(errorMessage: exception.msg, code: exception.code, errorFields: exception.causes ); 
}
